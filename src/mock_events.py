...
def get_mock_events() -> List[Dict[str, Any]]:
    ...
    mock_events: List[Dict[str, Any]] = [
        ...
        # Events in extended cities (Owerri, Warri)
        {
            "id": "evt_016",
            "name": "Owerri Cultural Night",
            "description": "A night of cultural celebration in Owerri",
            "event_type": "culture",
            "location": "Owerri",
            "city": "Owerri",
            "date": next_week.isoformat(),
        ...
        {
            "id": "evt_017",
            "name": "Warri Comedy Fiesta",
            "description": "Stand-up comedy show in Warri",
            "event_type": "entertainment",
            "location": "Warri",
            "city": "Warri",
            "date": this_saturday.isoformat(),
